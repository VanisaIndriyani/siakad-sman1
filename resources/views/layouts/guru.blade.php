    ...
    <div class="lg:ml-72 flex flex-col min-h-screen transition-all duration-300">
        ...
        <header class="glass-header h-20 flex items-center justify-between px-6 md:px-10 sticky top-0 z-20">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="relative group">
                    <button class="w-10 h-10 flex items-center justify-center rounded-xl bg-slate-50 text-slate-400 hover:bg-green-50 hover:text-green-600 transition-all border border-slate-100">
        ...
        <footer class="bg-white border-t border-slate-100 py-8 px-10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
                <a href="#" class="text-xs font-bold text-slate-400 hover:text-green-600 transition-colors uppercase tracking-widest">Bantuan</a>
                <a href="#" class="text-xs font-bold text-slate-400 hover:text-green-600 transition-colors uppercase tracking-widest">Kebijakan</a>
            </div>
        </footer>
    </div>
